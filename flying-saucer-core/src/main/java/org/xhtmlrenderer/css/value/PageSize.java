...
public class PageSize {
    ...
    public static final PageSize A5 = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "148mm"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "210mm"));
    ...
    public static final PageSize A4 = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "210mm"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "297mm"));
    ...
    public static final PageSize A3 = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "297mm"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "420mm"));
    
    /**
     * ISO B3 media: 176mm wide by 250mm high
     */
    public static final PageSize B3 = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "176mm"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "250mm"));
    ...
    public static final PageSize B4 = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "250mm"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "353mm"));
    
    /**
     * North American letter media: 8.5 inches wide and 11 inches high
     */
    public static final PageSize LETTER = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "8.5in"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "11in"));
    ...
    public static final PageSize LEGAL = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "8.5in"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "14in"));
    ...
    public static final PageSize LEDGER = new PageSize(
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "11in"),
            new FSCssValue(CSSPrimitiveValueExtension.CSS_MM, "17in"));
