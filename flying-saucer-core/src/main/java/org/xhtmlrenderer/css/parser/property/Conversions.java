...
public class Conversions {
    ...
    static {
        BORDER_WIDTHS.put("thin", new PropertyValue(CSSPrimitiveValueExtension.CSS_PX, 1.0f, "1px"));
        BORDER_WIDTHS.put("medium", new PropertyValue(CSSPrimitiveValueExtension.CSS_PX, 2.0f, "2px"));
        BORDER_WIDTHS.put("thick", new PropertyValue(CSSPrimitiveValueExtension.CSS_PX, 3.0f, "3px"));
    }
